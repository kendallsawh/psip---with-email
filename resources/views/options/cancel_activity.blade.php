	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="activitySurpressModalLabel">Cancelled/Surpress Action!</h5>
			...
			<div class="modal-body">
				...
				<form class="" method="POST" action="{{ route('activities.surpressactivity') }}" enctype="multipart/form-data">
					@csrf
					<h6>You are about to set this activity to the status of <strong>Cancelled/Surpress</strong>. Please take a moment to review the implications of this action.</h6>
